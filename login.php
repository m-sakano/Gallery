...
<html lang="ja">
  <head>
	...
	<style type="text/css">
		body { background-image: url("06.gif"); }
	</style>
  </head>
      ...
      <div class="site-wrapper-inner">
        ...
        <div class="cover-container">
          ...
          <div class="inner cover">
            <h1 class="cover-heading">Enjoy your private gallery.</h1>
            <p class="lead">
            	Login to get a funtastic experience!
            <p class="lead">
          ...
          <div class="mastfoot">
            <div class="inner">
              <p>Gallery is your private gallery.</p>
            </div>
          </div>
